      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm rounded-t-3xl border border-white/10 bg-black p-5 sm:rounded-none"
    ...
    <AnimatePresence>
      {toast && (
        <motion.div
          ...
          role="status"
          aria-live="polite"
          className="pointer-events-none fixed left-1/2 z-[100] flex -translate-x-1/2 items-center gap-2 rounded-full border border-white/40 bg-white/15 px-5 py-3 text-sm font-medium text-white shadow-[0_8px_30px_rgba(255,255,255,0.35)] backdrop-blur"
