        ...
        <div className="flex flex-col gap-2 border-t border-white/5 px-4 py-4">
          ...
          <div className="flex items-stretch gap-2">
            <input
              ...
              autoComplete="email"
              spellCheck={false}
              className="flex-1 rounded-sm border border-white/10 bg-white/[0.02] px-3 py-2 text-[13px] text-white placeholder:text-zinc-600 focus:border-white/40 focus:outline-none focus:ring-2 focus:ring-white/15"
            />
            <button
              type="button"
              onClick={onSendLink}
              disabled={!dirty || state.kind === 'pending'}
              className="rounded-sm bg-white px-4 py-2 text-[12px] font-semibold text-black transition-all hover:bg-zinc-100 hover:shadow-[0_0_0_2px_rgba(99,102,241,0.20)] disabled:opacity-40 disabled:hover:shadow-none"
            >
    ...
    >
        ...
        <div className="flex flex-col gap-4 border-t border-white/5 px-4 py-4">
          ...
          <div className="flex items-stretch gap-2">
            <input
              ...
              placeholder="123456"
              className="font-num flex-1 rounded-sm border border-white/10 bg-white/[0.02] px-3 py-2 text-center text-lg tabular-nums text-white tracking-[0.3em] placeholder:text-zinc-600 focus:border-white/40 focus:outline-none focus:ring-2 focus:ring-white/15"
            />
            <button
              type="button"
              onClick={verifySetup}
      ...
      {status === 'enabled' && (
        <div className="flex flex-col gap-3 border-t border-white/5 px-4 py-4">
          {backupCodes && (
            <div className="rounded-sm border border-white/30 bg-white/10/[0.04] p-4">
              ...
              <button
                ...
                className="mt-3 inline-flex items-center gap-1 text-[11px] text-white hover:text-white"
              >
